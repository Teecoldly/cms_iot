...
void setup()
{
  ...
  Serial.println("Connected to the WiFi network");
    ...
    delay(5000);
   if (sensor.init()) {
        Serial.println("Sensor AQI ready.");
    } else {
        Serial.println("Sensor AQI ERROR!");
    }
...
void checkLEDState() {
  ...
  String str = "{\"key\":\"" + String(cms_iot_key) + "\",\"humid\":\"" + String(h) + "\",\"temp\":\"" + String(t) + "\",\"pm10\":\"" + String(dustbuster10()) + "\",\"pm25\":\"" + String(dustbuster25()) + "\",\"lux\":\"" + String(lighter()) + "\",\"carbon\":\"" + String(aqi()) + "\",\"pir\":\"" + String(state_server_pir) + "\"}";
  Serial.println(str);
